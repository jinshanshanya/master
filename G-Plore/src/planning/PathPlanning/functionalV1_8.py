...
def control_steering(x_ref, y_ref,vehicle_length ,lateral_offset,delta_heading):
    ...
    error_angle1 = atan(lateral_offset*k_error/pre)*180/pi

    error_angle2 = delta_heading*h_error

    steering_wheel_angle = fd * (1*wheel_angle + 0*error_angle1 + 0*error_angle2) +25   # the ratio 15 is stil pending!
