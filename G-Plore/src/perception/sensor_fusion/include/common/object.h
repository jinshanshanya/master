...
#ifndef _GLB_AUTO_SENSORFUSION_COMMON_OBJECT_H_
#define _GLB_AUTO_SENSORFUSION_COMMON_OBJECT_H_
...
struct alignas(16) Object
{
  ...
  //8 points stand for bbox
  Eigen::Matrix<double,8,3> bbox=Eigen::Matrix<double,8,3>::Zero(); 
