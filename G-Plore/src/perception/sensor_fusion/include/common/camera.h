...
// namespace camera
// {
// glb_auto_perception_sensorfusion::ObjectType GetCameraObjType(Obs_Type obj_type)
// {
//         switch (obj_type)
//         {
//         case Obs_Type_Pedestrian:
//                 return glb_auto_perception_sensorfusion::ObjectType::PEDESTRIAN;
//         case Obs_Type_Car:
//                 return glb_auto_perception_sensorfusion::ObjectType::VEHICLE;
//         case Obs_Type_Bus:
//                 return glb_auto_perception_sensorfusion::ObjectType::VEHICLE;
//         case Obs_Type_Truck:
//                 return glb_auto_perception_sensorfusion::ObjectType::VEHICLE;
//         case Obs_Type_Bicycle:
//                 return glb_auto_perception_sensorfusion::ObjectType::BICYCLE;
//         case Obs_Type_Tricycle:
//                 return glb_auto_perception_sensorfusion::ObjectType::VEHICLE;
//         default:
//                 return glb_auto_perception_sensorfusion::ObjectType::UNKNOWN;
//         }
// }

// std::string GetCameraObjTypeName(Obs_Type obj_type)
// {
//         switch (obj_type)
//         {
//         case Obs_Type_Pedestrian:
...
// bool Filter(const CameraMsg::CameraObj &obj)
// {
//         // filter out fov
//         //if (obj.Long_Pos > 50 || obj.Long_Pos < 0.5 || obj.Lat_Pos > 5 || obj.Lat_Pos < -5)
//         // if (obj.Long_Pos > 50 || obj.Long_Pos < 0.5 )
//         // {
//         //         return true;
//         // }
//         // // fliter out abnormal velocity
//         // // if (obj.Long_Vel > 20 || obj.Long_Vel < -20 || obj.Lat_Vel > 20 || obj.Lat_Vel < -20)
//         // // {
//         // //         return true;
//         // // }
//         // // fliter out abnormal geometry
//         // //if (obj.Height > 10 || obj.Height < 0.5 || obj.Width > 10 || obj.Width < 0.5)
