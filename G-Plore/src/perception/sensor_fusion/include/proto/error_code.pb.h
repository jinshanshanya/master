...
class StatusPb : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:glb_auto_perception_sensorfusion.StatusPb) */ {
 public:
  StatusPb();
  virtual ~StatusPb();
  ...
  // @@protoc_insertion_point(class_scope:glb_auto_perception_sensorfusion.StatusPb)
 private:
...
inline ::glb_auto_perception_sensorfusion::ErrorCode StatusPb::error_code() const {
...
inline void StatusPb::set_error_code(::glb_auto_perception_sensorfusion::ErrorCode value) {
...
template <> struct is_proto_enum< ::glb_auto_perception_sensorfusion::ErrorCode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::glb_auto_perception_sensorfusion::ErrorCode>() {
  return ::glb_auto_perception_sensorfusion::ErrorCode_descriptor();
}
