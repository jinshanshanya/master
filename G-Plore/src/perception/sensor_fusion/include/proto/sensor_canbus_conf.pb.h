...
#ifndef PROTOBUF_sensor_5fcanbus_5fconf_2eproto__INCLUDED
#define PROTOBUF_sensor_5fcanbus_5fconf_2eproto__INCLUDED
...
class SensorCanbusConf : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:glb_auto_perception_sensorfusion.SensorCanbusConf) */ {
 public:
  SensorCanbusConf();
  ...
  const ::glb_auto_perception_sensorfusion::CANCardParameter& can_card_parameter() const;
  ::glb_auto_perception_sensorfusion::CANCardParameter* mutable_can_card_parameter();
  ::glb_auto_perception_sensorfusion::CANCardParameter* release_can_card_parameter();
  void set_allocated_can_card_parameter(::glb_auto_perception_sensorfusion::CANCardParameter* can_card_parameter);
  ...
  // @@protoc_insertion_point(class_scope:glb_auto_perception_sensorfusion.SensorCanbusConf)
 private:
  ...
  ::glb_auto_perception_sensorfusion::CANCardParameter* can_card_parameter_;
  bool enable_debug_mode_;
  bool enable_receiver_log_;
  friend struct protobuf_sensor_5fcanbus_5fconf_2eproto::TableStruct;
};
// ===================================================================
...
inline const ::glb_auto_perception_sensorfusion::CANCardParameter& SensorCanbusConf::can_card_parameter() const {
...
inline ::glb_auto_perception_sensorfusion::CANCardParameter* SensorCanbusConf::mutable_can_card_parameter() {
...
inline ::glb_auto_perception_sensorfusion::CANCardParameter* SensorCanbusConf::release_can_card_parameter() {
...
inline void SensorCanbusConf::set_allocated_can_card_parameter(::glb_auto_perception_sensorfusion::CANCardParameter* can_card_parameter) {
...
#endif  // PROTOBUF_sensor_5fcanbus_5fconf_2eproto__INCLUDED
