...
#ifndef _GLB_AUTO_SENSORFUSION_FUSION_PROBABILISTIC_FUSION_PBF_SENSOR_MANAGER_H_  // NOLINT
#define _GLB_AUTO_SENSORFUSION_FUSION_PROBABILISTIC_FUSION_PBF_SENSOR_MANAGER_H_  // NOLINT
