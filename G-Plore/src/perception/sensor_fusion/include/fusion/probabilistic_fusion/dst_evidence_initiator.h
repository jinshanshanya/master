...
#ifndef _GLB_AUTO_SENSORFUSION_FUSION_PROBABILISTIC_FUSION_DST_EVIDENCE_INITIATOR_H_  // NOLINT
#define _GLB_AUTO_SENSORFUSION_FUSION_PROBABILISTIC_FUSION_DST_EVIDENCE_INITIATOR_H_  // NOLINT
