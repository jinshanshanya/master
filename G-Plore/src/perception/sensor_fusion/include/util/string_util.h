...
#ifndef _GLB_AUTO_SENSORFUSION_UTIL_STRING_UTIL_H_
#define _GLB_AUTO_SENSORFUSION_UTIL_STRING_UTIL_H_
...
/**
 * @namespace glb_auto::common::util
 * @brief glb_auto::common::util
 */
