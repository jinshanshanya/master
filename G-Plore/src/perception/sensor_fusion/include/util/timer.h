...
#ifndef _GLB_AUTO_SENSORFUSION_UTIL_TIMER_H_
#define _GLB_AUTO_SENSORFUSION_UTIL_TIMER_H_
...
#define PERF_FUNCTION(function_name) \
  glb_auto_perception_sensorfusion::time::TimerWrapper _timer_wrapper_(function_name)

#define PERF_BLOCK_START()             \
  glb_auto_perception_sensorfusion::time::Timer _timer_; \
  _timer_.Start()
