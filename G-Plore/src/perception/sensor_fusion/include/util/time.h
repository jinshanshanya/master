 ...
 * precision at 1us.
 */
#ifndef _GLB_AUTO_SENSORFUSION_UTIL_TIME_CLOCK_H_
#define _GLB_AUTO_SENSORFUSION_UTIL_TIME_CLOCK_H_
...
/**
 * @namespace glb_auto::common::time
 * @brief glb_auto::common::time
 */
...
#define PERF_BLOCK_WITH_THRESHOLD(message, threshold)                         \
  using glb_auto_perception_sensorfusion::time::Clock;                                          \
