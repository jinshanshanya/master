...
float PbfTrackObjectDistance::ComputeDistance3D(
  ...
  fused_poly_center(0)=obj->center(0);
  fused_poly_center(1)=obj->center(1);
  // bool fused_state =
  ...
  sensor_poly_center(0)=obj2->center(0);
  sensor_poly_center(1)=obj2->center(1);
  // bool sensor_state =
...
// comment by zhiming ,now we have no pointcloud data
/* 
