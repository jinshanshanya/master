...
DEFINE_string(camera_extrinsics_file,
              "/home/yx/shared_dir/glb_auto_perception_sensorfusion/src/perception/glb_auto_perception_sensorfusion/config/calibration.yaml",
...
// /* dag streaming config for glb_auto 2.0 */
...
// // Ex: /glb_auto/modules/perception/data/yolo_camera_detector_test/test.jpg
